...
const _defaultHost = "webservices.amazon.com";
...
class Sigv4Client implements BaseSigv4Client {
  ...
  Map<String, String> signedHeaders(
    ...
    tempHeaders.remove('Accept');
    tempHeaders.remove('Accept-Language');
  ...
  String _generateAuthorization({
    ...
    Map<String, dynamic> query,
    Map<String, dynamic> headers, //required
