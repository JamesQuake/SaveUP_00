...
//
//     final amazonRes = amazonResFromJson(jsonString);

import 'dart:convert';

AmazonRes amazonResFromJson(String str) => AmazonRes.fromJson(json.decode(str));

String amazonResToJson(AmazonRes data) => json.encode(data.toJson());
...
class AmazonRes {
  ...
  factory AmazonRes.fromJson(Map<String, dynamic> json) => AmazonRes(
...
class SearchRefinements {
  ...
  factory SearchRefinements.fromJson(Map<String, dynamic> json) =>
      SearchRefinements(
        searchIndex: json["SearchIndex"] == null
            ? null
            : SearchIndex.fromJson(json["SearchIndex"]),
      );

  Map<String, dynamic> toJson() => {
        "SearchIndex": searchIndex == null ? null : searchIndex.toJson(),
      };
}
...
class SearchIndex {
  ...
  factory SearchIndex.fromJson(Map<String, dynamic> json) => SearchIndex(
        bins: json["Bins"] == null
            ? null
