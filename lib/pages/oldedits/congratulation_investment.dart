...
// class CongratulationsInvestment extends StatefulWidget {
//   final String uid, investAmount, savedPerSession;
//   final InvestmentModel investmentModel;
//   final double decimalForProgress;

//   @override
//   _CongratulationsInvestmentState createState() =>
//       _CongratulationsInvestmentState(uid, investmentModel, investAmount,
//           savedPerSession, decimalForProgress);
...
//       this.investAmount,
//       this.savedPerSession,
//       this.decimalForProgress})
//       : super(key: key);
// }

// class _CongratulationsInvestmentState extends State<CongratulationsInvestment> {
//   String _uid, investAmount, savedPerSession;
//   List<AccountModel> _list;
//   InvestmentModel investmentModel;
//   double decimalForProgress;
//   double revesedDecimal = 0.0;

//   _CongratulationsInvestmentState(this._uid, this.investmentModel,
//       this.investAmount, this.savedPerSession, this.decimalForProgress);
...
//         investmentModel.url, investmentModel.goal, investmentModel.amount, ''));
//     _list.add(AccountModel(
//         "https://lh3.googleusercontent.com/X53ujeXOMglEfk6xDU7v07_aZyiczlhJoZF_dl2_L8uFPgyvguQ2QLQ3x6hZ_XVJY4rUwjQlLcSmbvStE9D3nyOkwZMj2i-cSm_TBy0",
...
//               ),
//               Text(
//                 "You just invested \$" + savedPerSession + " toward:",
