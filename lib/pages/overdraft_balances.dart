...
// class OverdraftBalances extends StatefulWidget {
//   final String uid;
//   final double overdraftAmount;

//   @override
//   _OverdraftBalancesState createState() =>
//       _OverdraftBalancesState(uid, overdraftAmount);

//   OverdraftBalances({Key key, @required this.uid, this.overdraftAmount})
//       : super(key: key);
// }

// const testDevices = "Your_DEVICE_ID";

// class _OverdraftBalancesState extends State<OverdraftBalances> {
...
//   _OverdraftBalancesState(this._uid, this.overdraftAmount);

//   @override
//   void initState() {
//     super.initState();
//     _coins = 100;
//     _checking = overdraftAmount;
